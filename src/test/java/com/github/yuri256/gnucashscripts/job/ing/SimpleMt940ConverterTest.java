...
class SimpleMt940ConverterTest {
    ...
    public void testFields() {
        final HashSet<String> descriptionSkipFields = new HashSet<>();
        SimpleMt940Record record = new SimpleMt940Converter(new DescriptionConverter(new DescriptionFilterFunction(descriptionSkipFields, Set.of(IngConstants.NAAM_OMSCHRIJVING, IngConstants.NAAM, IngConstants.OMSCHRIJVING)))).apply(new IngRecord("20010304", "Test Name-Desc", "TestRekening", "TestTegenRekening", "BA", AfBij.Af, "12,34", "Betaalautomaat", "Pasvolgnr: 001 07-03-2020 09:34 Transactie: A111B2 Term: AB1234 Valutadatum: 07-03-2020"));
